...
You will find `src/config/index.js` file which contains the complete information about the user. The file looks something like below:
...
You can change the personal information, experience, education, social media, certifications, blog information, contact information etc. in `src/config/index.js` to directly reflect them in portfolio website.
...
- If you don't want Splash screen or you don't know how to design logo, then this option is for you
  ...
  - You can open `src/config/index.js` file and at the top of this file you will see `settings` component as below:
    ```javascript
  ...
  - If you design your logo in future, then edit the files in `./src/components/Loader` and then revert `isSplash` to `true` in `src/config/index.js`.
...
<table>
  <tbody>
    ...
    <tr>
      <td align="center" valign="top" width="14.28%"><a href="http://a-mishra.github.io"><img src="https://avatars0.githubusercontent.com/u/10567548?v=4?s=100" width="100px;" alt="Kassem Mishra"/><br /><sub><b>Kassem Mishra</b></sub></a><br /><a href="https://github.com/ashutosh1919/masterPortfolio/commits?author=a-mishra" title="Code">💻</a></td>
